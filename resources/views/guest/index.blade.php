		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="section-title">
					<h3 class="title"><span>Judge</span> <span style="color:#c28d4b;">List</span></h3>
				</div>
				<!-- /section title -->
				<div id="galery">
		<!-- container -->
			...
			<div class="row">
				...
				<div id="galery-owl" class="owl-carousel owl-theme">
					...
					<div class="galery-item">
						<img src="./img/judges/adi.jpg" alt="" height="600px" width="422px">
					</div>
					<!-- /galery item -->
	...
	<div id="schedule" class="section">
		...
		<div class="container">
			...
			<div class="row">
				<!-- section title -->
				<div class="section-title">
					<h3 class="title"><span>Event</span> <span style="color: #c28d4b;">Schedule</span></h3>
				</div>
				<!-- /section title -->
	...
	<div id="speakers" class="section">
		...
		<div class="container">
			...
			<div class="row">
				<!-- section title -->
				<div class="section-title">
					<h3 class="title"><span>Our</span> <span style="color: #c28d4b;">Judges</span></h3>
				</div>
				<!-- section title -->
	...
	<div id="sponsors" class="section">
		...
		<div class="container">
			...
			<div class="row">
				<!-- section title -->
				<div class="section-title">
					<h3 class="title"><span>Our</span> <span style="color: #c28d4b;">Sponsors</span></h3>
				</div>
				<!-- /section title -->
	...
	<div id="contact" class="section">
		...
		<div class="container">
			...
			<div class="row">
				<!-- section title -->
				<div class="section-title">
					<h3 class="title"><span>Contact</span> <span style="color: #c28d4b;">Info</span></h3>
				</div>
				<!-- /section title -->
